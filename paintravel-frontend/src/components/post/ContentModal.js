    ...
    <div className="modalContainer" style={{background: `${modalBg}`}}>
      <div className="modalDiv" style={{top: `${modalOpenAnimation}`, opacity:`${modalOpenOpacity}`}}>
        ...
        <ul className="modalBody">
          <li style={{transform:"translateX("+ `${modalImgPosition}`+"%)"}}><img src={require("../../img/login/loginBg.jpg")}/></li>
          <li style={{transform:"translateX("+`${modalImgPosition}`+"%)"}}><img src={require("../../img/mypage/mypageBg.png")}/></li>
          <li style={{transform:"translateX("+`${modalImgPosition}`+"%)"}}><img src={require("../../img/login/loginBg.jpg")}/></li>
          <li style={{transform:"translateX("+`${modalImgPosition}`+"%)"}}><img src={require("../../img/mypage/mypageBg.png")}/></li>
        </ul>
        <ol className="modalPagination">
          <li onClick={imgSlidePre}><span>이전</span><a href="#">&#60;</a></li>
          <li><a href="#" style={modalSlideBtn1st} onClick={() => {setModalCurrentSlide(0)}}></a></li>
          <li><a href="#" style={modalSlideBtn2nd} onClick={() => {setModalCurrentSlide(1)}}></a></li>
          <li><a href="#" style={modalSlideBtn3rd} onClick={() => {setModalCurrentSlide(2)}}></a></li>
          <li><a href="#" style={modalSlideBtn4th} onClick={() => {setModalCurrentSlide(3)}}></a></li>
          <li onClick={imgSlideNext}><span>다음</span><a href="#">&#62;</a></li>
        </ol>
